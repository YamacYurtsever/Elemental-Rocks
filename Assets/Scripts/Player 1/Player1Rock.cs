...
public class Player1Rock : MonoBehaviour
{
    //Elements
    private int fire = 0;
    private int water = 0;
    ...
    private Player2HealthSystem player2HealthSystem;
    ...
    private void Start()
    {
        ...
        player2HealthSystem = player2.GetComponent<Player2HealthSystem>();
    ...
    {
        if (col.IsTouching(player2Col))
        {
            player2HealthSystem.TakeDamage(rockDamage);
            Destroy(gameObject);
        }
